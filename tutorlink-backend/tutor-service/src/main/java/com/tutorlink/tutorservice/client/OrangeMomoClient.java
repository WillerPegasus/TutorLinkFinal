package com.tutorlink.tutorservice.client;
...
public class OrangeMomoClient {
    ...
    /**
     * Étape 1 — obtenir un token OAuth2 (client_credentials, Basic Auth client_id:client_secret)
     */
    ...
    /**
     * Étape 2 — initier le paiement (webpayment).
     * Retourne l'URL vers laquelle rediriger le client pour qu'il finalise le paiement,
     * ainsi que le pay_token associé (utile pour vérifier le statut plus tard).
     */
    ...
    /**
     * Étape 3 — vérifier le statut d'une transaction (SUCCESS, FAILED, EXPIRED, PENDING)
     * via l'endpoint transactionstatus, en passant order_id et amount.
     */
